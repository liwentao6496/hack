<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"C:\Users\Administrator\Desktop\fastadmin\public/../application/admin\view\news\add.html";i:1563890544;s:83:"C:\Users\Administrator\Desktop\fastadmin\application\admin\view\layout\default.html";i:1562338655;s:80:"C:\Users\Administrator\Desktop\fastadmin\application\admin\view\common\meta.html";i:1562338655;s:82:"C:\Users\Administrator\Desktop\fastadmin\application\admin\view\common\script.html";i:1562338655;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" data-rule="required" data-source="category/selectpage" data-params='{"custom[type]":"news"}' class="form-control selectpage" name="row[category_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-addtime" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[addtime]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Click'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-click" class="form-control" name="row[click]" type="number" value="66">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-issue" class="form-control" name="row[issue]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-brief" class="form-control" name="row[brief]" type="text">
        </div>
    </div>
