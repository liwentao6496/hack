                ...
                <div class="panel-body pt-0">
                    <div class="channel-list">
                        <div class="row">
                            <!-- S 栏目列表 -->
                            <div class="col-xs-12">
                            <h3><a href="/cms/c/wearable.html">最新源码</a> <em><a href="/index/down/index">更多</a></em></h3>
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-md-3 product-item">
                                    <div class="card">
                                        ...
                                        <div class="title">
                                            <h2><a href="index/down/content/id/<?php echo $vo['id']; ?>" style="font-weight:bold;"><?php echo $vo['title']; ?></a></h2>
                                        </div>
                                        <div class="operate">
                    ...
                    <span class="">
                        <i class="fa fa-eye"></i> <?php echo $vo['click']; ?>                    </span>
                            ...
                            <div class="col-xs-12">
                                <h3><a href="/cms/c/wearable.html">推荐源码</a> <em><a href="/index/down/index">更多</a></em></h3>
                                <div class="row">
                    ...
                    <div class="channel-list">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <h3><a href="index/news">热门项目</a> <em><a href="/index/news/lists/id/">更多</a></em></h3>
                                <?php if(is_array($news_click) || $news_click instanceof \think\Collection || $news_click instanceof \think\Paginator): $i = 0; $__LIST__ = $news_click;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading"><a href="/index/news/content/id/<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></a></h3>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <h3><a href="index/news">推荐项目</a> <em><a href="/index/news/lists/id/">更多</a></em></h3>
                                <?php if(is_array($news_click1) || $news_click1 instanceof \think\Collection || $news_click1 instanceof \think\Paginator): $i = 0; $__LIST__ = $news_click1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <div class="media">
                                    <div class="media-left">
                                        <a href="/index/news/content/id/<?php echo $vo['id']; ?>">
                                            <div class="embed-responsive embed-responsive-4by3 img-zoom">
